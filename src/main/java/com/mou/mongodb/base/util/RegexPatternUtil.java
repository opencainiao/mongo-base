...
public class RegexPatternUtil {
	 ...
	 * @return
	 */
	public static Pattern getLeftLikePattern(String strIn) {
	 ...
	 * @return
	 */
	public static Pattern getRightLikePattern(String strIn) {
		...
		return Pattern.compile("^" + use + ".*name$", Pattern.CASE_INSENSITIVE);
	}
